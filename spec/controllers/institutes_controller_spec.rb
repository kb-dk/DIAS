  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved institute as @institute" do
        ...
        post :create, {:institute => { "title" => "invalid value" }}, valid_session
        assigns(:institute).should be_a_new(Institute)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested institute" do
        ...
        Institute.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => institute.to_param, :institute => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the institute as @institute" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Institute.any_instance.stub(:save).and_return(false)
        put :update, {:id => institute.to_param, :institute => { "title" => "invalid value" }}, valid_session
        assigns(:institute).should eq(institute)
      end
